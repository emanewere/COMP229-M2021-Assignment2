...
import contactLRouter from '../Routes/contactL';
...
mongoose.connect(DBConfig.RemoteU, {useNewUrlParser: true, useUnifiedTopology: true});
...
app.use('/', indexRouter);
app.use('/contact-list', contactLRouter);
